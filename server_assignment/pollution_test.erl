...
%%% @doc
%%% EUnit test module for pollution. Contains tests for all pollution operations.
%%%-------------------------------------------------------------------
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Test for creating a new monitor and checking equality.
create_monitor_test() ->
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Test for adding a station and checking error cases.
add_station_test() ->
  M1 = pollution:create_monitor(),
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Test for adding values to a station and checking correct addition.
add_value_test() ->
